...
export default function BlogPage() {
  ...
  useEffect(() => {
    if (selectedItem) {
      const newIndex = portfolioItems.findIndex((item) => item.id === selectedItem.id)
      if (newIndex !== -1) {
      ...
      <div className="relative z-10 pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">Portfolio Gallery</h1>
            <p className="text-lg text-pink-100 mb-8">
              Explore our collection of work showcasing beautiful transformations and creative artistry. Each image
              represents our commitment to bringing out your unique beauty.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto text-center mt-20 bg-white/10 backdrop-blur-sm p-8 rounded-xl">
            ...
            <h2 className="text-2xl font-bold mb-4 text-white">Follow Us on Instagram</h2>
            <p className="text-pink-100 mb-6">
              For inspiration, behind-the-scenes content, and our latest work, follow us on Instagram.
            </p>
            <Button
              className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white"
              asChild
            >
              <a href={`${process.env.NEXT_PUBLIC_INSTAGRAM}`} target="_blank" rel="noreferrer">
